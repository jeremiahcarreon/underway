...
(async()=>{
  ...
  await pickWeapon(b,'mine'); console.log('mine btn:', await b.eval(`document.querySelector('.weapons button:nth-child(4)').textContent`)); await tapEnemy(b,xp[0]); await b.click('#btn-fire'); await b.wait(600); await b.shot(__dirname+'/w_mine_contact.png'); s=await settle(b);
